...
public class MyConnection {
    ...
    private static final String CONNECT_STR = "jdbc:mysql://localhost:3306/motocicletta?user=root&password=Mac.0123&allowPublicKeyRetrieval=true&useSSL=FALSE&serverTimezone=UTC";
